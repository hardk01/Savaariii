'use client'
// import ThemeSwitch = dynamic(() => import(''), { ssr: false })
...
export default function Header1({ scroll, isMobileMenu, handleMobileMenu, handleOffcanvas, isOffcanvas }: any) {
	...
	useEffect(() => {
		const handleScroll = () => {
			setScroll(window.scrollY > 100); // Add 'stick' class if scrolled more than 50px
		};
							...
							<div className="header-nav">
								<nav className="nav-main-menu">
									<ul className="main-menu">
										<li 
										// className="has-children arrow-white"
										>
										...
										<li 
										// className="mega-li-small has-children arrow-white"
										>
											<Link className="color-white" href="/about">About Us</Link>
										...
										// className="has-children arrow-white"
										>
											<Link className="color-white" href="/blog">Blog</Link>
											{/* <ul className="sub-menu">
