...
import { swiperGroup3, swiperGroupAnimate } from '@/utility/swiperOptions'
						...
						<div className="container">
							<div className="row pb-50">
								...
								<div className="col-lg-7 offset-lg-1">
									<p className="text-lg-medium neutral-500">Welcome to Carento, your trusted partner in car rentals. Since our founding, we have been committed to providing our customers with a seamless and reliable car rental experience. Whether youre planning a business trip, a family vacation, or just need a vehicle for everyday use, we offer a wide range of vehicles to meet your needs.</p>
								</div>
							</div>
								...
								<div className="col-lg-3 col-sm-6">
									<div className="card-why text-start wow fadeInUp">
										...
										<div className="card-info">
											...
											<p className="text-md-medium neutral-500">Enjoy clear and upfront pricing with no surprises, ensuring you know exactly what youre paying for.</p>
										</div>
									</div>
								</div>
								<div className="col-lg-3 col-sm-6">
							...
							<div className="container">
								<div className="row align-items-center">
									<div className="col-lg-5">
										...
										<p className="text-lg-medium neutral-500 mb-4">Our mission is to make car rental easy, accessible, and affordable for everyone. We believe that renting a car should be a hassle-free experience, and were dedicated to ensuring that every customer finds the perfect vehicle for their journey.</p>
										<div className="row">
											<div className="col">
												...
												<SwiperSlide className="swiper-slide">
													<div className="card-testimonial background-card">
														<div className="card-info">
															...
															<p className="text-md-regular neutral-500">The overall process was not just efficient but also enriching, as the platforms intuitive design and user-friendly interface made every step enjoyable.</p>
														</div>
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
